...
public partial class KeyboardMappingEditor : BaseControlMappingEditor
{
    ...
    public override void _Ready()
    {
        ...
        holder.GetNode<EnumInput>("TypeInput").Config(null, "Mode",
            s => controlMapping.KeyboardMappingType,
            (s, v) =>
            {
                controlMapping.KeyboardMappingType = (SimInput.KeyboardControlMapping.MappingTypeEnum)v;
    ...
    {
        var visible = controlMapping.KeyboardMappingType == SimInput.KeyboardControlMapping.MappingTypeEnum.ThreePosition;
